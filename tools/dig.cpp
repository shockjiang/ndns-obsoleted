...
main (int argc, char * argv[])
{
  ...
  try {
    ...
    config.add_options () ("waiting,w", po::value<int> (&waitingSeconds),
                           "set waiting seconds for every Interest. default: 10") (
    ...
    hidden.add_options () ("name", po::value<string> (&dstLabel), "name to be resolved") (
    ...
    cout << "name=" << dstLabel << " resolver=" << resolver << " waiting=" << waitingSeconds
